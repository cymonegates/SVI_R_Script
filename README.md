...
This code was based on the CDC's 2018 SVI methodology, which is slightly different from prior years (2016 and earlier) and may be different from future years if the CDC makes any changes. 
